...
class Contactus extends DAS_REST_Controller{

    function __construct()
    {
        // Construct the parent class
        parent::__construct('contactus/contactus_m','cm');
		
    }
	
		/**
      * @api {get} /Contactus Get all Contactus
      * @apiName index
      * @apiGroup Contactus
      *
      * @apiSuccess 200 OK.
	...
	{
		parent::delete_get();//$this->response('this method is not supported',400);
	}
