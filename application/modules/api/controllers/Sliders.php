...
class Sliders extends DAS_REST_Controller{

    function __construct()
    {
        // Construct the parent class
        parent::__construct('sliders/sliders_m','sm');
		
    }
	
		/**
      * @api {get} /Sliders Get all sliders
      * @apiName index
      * @apiGroup sliders
      *
      * @apiSuccess 200 OK.
	...
	/**
	* @api {post} /sliders Add New Slider
      * @apiName index
      * @apiGroup sliders
      *
      * @apiSuccess 200 OK.
	...
	/**
      * @api {post} /sliders/update/1 Update slider by id
      * @apiName update
      * @apiGroup sliders
      *
      * @apiSuccess 200 OK.
	...
	/**
      * @api {delete} /sliders/?id=7 Delete slider by id
      * @apiName index
      * @apiGroup sliders
      *
      * @apiSuccess 200 OK.
